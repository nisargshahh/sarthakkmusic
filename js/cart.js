...
function updateCartTotal() {
	...
	for (let j = 1; j < cartRows.length; j++) {
		...
		let productPriceElement = cartRow.getElementsByClassName('product-price')[0]
		let quantityElement = cartRow.getElementsByClassName('quantity')[0]
		let rowTotalPriceElement = cartRow.getElementsByClassName('row-total-price')[0]
		let totalPriceRsElement = document.getElementsByClassName('total-price-rs')[0]
